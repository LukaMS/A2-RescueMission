# [A2] Island ca.mcmaster.se2aa4.island.team211.Explorer

- Authors:
  - [Luka, Mahrt-Smith](mahrtsml@mcmaster.ca) 
  - [Zachary, Dibussolo](dibussoz@mcmaster.ca)

## Product Description

This product is an _exploration command center_ for the [Island](https://ace-design.github.io/island/) serious game. 

- The `ca.mcmaster.se2aa4.island.team_211_.Explorer` class implements the command center, used to compete with the others. (XXX being the team identifier)
